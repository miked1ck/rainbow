...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Items3 = __webpack_require__(208);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  { store: (0, _redux.createStore)(_Items4.default) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var focusAndCheck = function focusAndCheck(event, target) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colors = __webpack_require__(206);

	var _colors2 = _interopRequireDefault(_colors);

	var _items = __webpack_require__(207);
	...
	var Items = function (_React$Component) {
	  ...
	  function Items() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Items).call(this));

	    var keys1 = Object.keys(_items2.default);
	    var keys2 = Object.keys(_items2.default);
	    _this.items_x2 = [].concat(_toConsumableArray(keys1), _toConsumableArray(keys2));
	    return _this;
	  }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.items_x2.map(function (key, index) {
	          i = Object.keys(_colors2.default).length % index == 0 && index > 0 ? 0 : i + 1;
	          return _react2.default.createElement(_Item2.default, { item: _items2.default[key], index: index, color: _colors2.default[i] });
	        }.bind(this))
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrollJs = __webpack_require__(195);
	...
	var Item = function (_React$Component) {
	  ...
	  _createClass(Item, [{
	    key: '_onClickItem',
	    value: function _onClickItem(index) {
	      var scroll = new _scrollJs2.default(document.body);
	    ...
	    key: '_isExpanded',
	    value: function _isExpanded(index) {
	      var classes = [];

	      if (index === this.props.expandingTo) classes.push('is-expandingTo');

	      if (index === this.props.expandingFrom) classes.push('is-expandingFrom');
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { className: 'Item ' + this._isExpanded(index), onClick: function onClick() {
	            return _this2._onClickItem(index);
	...
	var itemState = function itemState(state) {
	  return { expandingTo: state.expandingTo, expandingFrom: state.expandingFrom };
	};

	var itemDispatch = function itemDispatch(dispatch) {
	  return {
	    _onClickItem: function _onClickItem(index) {
	...
	exports.default = (0, _reactRedux.connect)(itemState, itemDispatch)(Item);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asap = __webpack_require__(199);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"dried_fruit": {
			"title": "Dried Fruit",
			"subtitle": "Primary",
			"meta": ["Raisin", "Fig", "Date", "Fruitcake"]
		},
		"black_fruit": {
			"title": "Black Fruit",
			"subtitle": "Primary",
			"meta": ["Boysenberry", "Black Currant", "Black Cherry", "Plum", "Blackberry", "Blueberry", "Olive"]
		},
		"red_fruit": {
			"title": "Red Fruit",
			"subtitle": "Primary",
			"meta": ["Cranberry", "Red Plum", "Pomegranate", "Sour Cherry", "Strawberry", "Cherry", "Raspberry", "Red Currant"]
		},
		"tropical_fruit": {
			"title": "Tropical Fruit",
			"subtitle": "Primary",
			"meta": ["Pineapple", "Mango", "Guava", "Kiwi", "Lychee", "Bubblegum", "Melon", "Passion Fruit", "Lychee", "Melon", "Passion Fruit"]
		},
		"tree_fruit": {
			"title": "Tree Fruit",
			"subtitle": "Primary",
			"meta": ["Quince", "Apple", "Pear", "Nectarine", "Peach", "Apricot", "Persimmon", "Green Apple"]
		},
		"citrus": {
			"title": "Citrus",
			"subtitle": "Primary",
			"meta": ["Lime", "Lemon", "Grapefruit", "Orange", "Marmalade", "Mandarine"]
		},
		"flower": {
			"title": "Flower",
			"subtitle": "Primary",
			"meta": ["Iris", "Peony", "Elderflower", "Acacia", "Lilac", "Jasmine", "Honeysuckle", "Violet", "Lavender", "Rose", "Potpourri", "Hibiscus", "Hawthorn", "Orange blossom", "linden"]
		},
		"volatile_acidity": {
			"title": "Volatile Acidity",
			"subtitle": "Faults",
			"meta": ["Balsamic", "Vinegar"]
		},
		"cooked_fruit": {
			"title": "Cooked Fruit",
			"subtitle": "Faults",
			"meta": ["Stewed Fruit", "Toffee"]
		},
		"brettanomyces": {
			"title": "Brettanomyces",
			"subtitle": "Faults",
			"meta": ["Horse Manure", "Sweaty Leather Saddle", "Band-Aid", "Black Cardamon"]
		},
		"sulfides_mercaptans": {
			"title": "Sulfides",
			"subtitle": "Faults",
			"meta": ["Cat Pee", "Onion", "Garlic", "Match Box", "Burnt Rubber", "Boiled Eggs", "Cured Meat"]
		},
		"tca_corked": {
			"title": "TCA (corked)",
			"subtitle": "Faults",
			"meta": ["Wet Dog", "Musty Cardboard"]
		},
		"general_aging": {
			"title": "General Aging",
			"subtitle": "Tertiary",
			"meta": ["Leather", "Cocoa", "Coffee", "Tobacco", "Hay", "Nuts", "Dried Fruit"]
		},
		"oak_aging": {
			"title": "Oak Aging",
			"subtitle": "Tertiary",
			"meta": ["Dill", "Smoke", "Cigar Box", "Baking Spices", "Coconut", "Vanilla", "Toast"]
		},
		"microbial": {
			"title": "Microbial",
			"subtitle": "Secondary",
			"meta": ["Mushroom", "Truffle", "Tree Moss", "Lager", "Sourdough", "Cream", "Butter", "Yoghurt"]
		},
		"earth": {
			"title": "Earth",
			"subtitle": "Primary",
			"meta": ["Petroleum", "Volcanic Rocks", "Red Beet", "Potting Soil", "Wet Gravel", "Slate", "Clay Pot"]
		},
		"vegetable": {
			"title": "Vegetable",
			"subtitle": "Primary",
			"meta": ["Black Tea", "Sun Dried Tomato", "Tomato", "Bitter Almond", "Jalapeno", "Green Pepper", "Bell Pepper", "Gooseberry", "Tout Leaf", "Grass"]
		},
		"spice": {
			"title": "Spice",
			"subtitle": "Primary",
			"meta": ["Thyme", "Mint", "Eucalyptus", "Fennel", "5-Spice", "Anise", "Cinnamon", "Black Pepper", "Red Pepper", "White Pepper", "Dill", "Clove", "Nutmeg", "Licorice", "Vanilla"]
		},
		"noble_rot": {
			"title": "Noble Rot",
			"subtitle": "Primary",
			"meta": ["Beeswax", "Ginger", "Honey"]
		}
	};
...
/***/ function(module, exports) {
	...
	var help = {
	  ...
	  expand: function expand(state, action) {
	  ...
	  collapse: function collapse(state, action) {
	...
	function AppReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? help.initState : arguments[0];
	  var action = arguments[1];
